...
public class ScriptFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootview = (ViewGroup)inflater.inflate(R.layout.fragment_script,container,false);
        Button with=(Button)rootview.findViewById(R.id.with);
        Button script1=(Button)rootview.findViewById(R.id.script1);

        with.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent=new Intent(getActivity(), WithPopUpActivity.class);
