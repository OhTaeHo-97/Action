...
public class FeedFragment extends Fragment {
    ...
    List<MediaController> mc_list=new ArrayList<MediaController>();
    int total_size = 0;
    int count=0;
                    ...
                    if (result != null || result.length() != 0) {
                        ...
                        for(int i=0;i<file_path.size();i++){
                            for(int j=0;j<file_path.get(i).length;j++){
                                ...
                                mc_list.add(mc);
                                video.setMediaController(mc_list.get(count));
                                ...
                                start_buttons.get(count).setOnClickListener(new View.OnClickListener(){
                                ...
                                stop_buttons.get(count).setOnClickListener(new View.OnClickListener(){
                                    public void onClick(View v){
                                        videoViews.get(count).seekTo(0);
                                        videoViews.get(count).start();
                                    }
